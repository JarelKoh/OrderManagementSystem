...
/**
 * This class allows adding a new menu item to a restaurant's menu.
 */
public class AddMenuItem extends PermutableBranch{
    /**
     * Constructs an AddMenuItem instance.
     */
    public AddMenuItem(){}
    /**
     * Requests input from the user to add a new item to the menu.
     * If the item already exists by ID or name, an error is displayed.
     * Otherwise, the new item is added to the menu.
     *
     * @param br the branch to which the menu item is added
     */
