...
/**
 * The EditStaff class extends the Permutable class and provides functionality
 * to add or edit staff accounts in a branch.
 */
 ...
 */
    public EditStaff(){};
    /**
     * Prompts the user to select a branch and choose whether to add a new staff account
     * or edit an existing staff account. Handles the corresponding operations based on
     * the user's choice.
     */
    public void request(){
