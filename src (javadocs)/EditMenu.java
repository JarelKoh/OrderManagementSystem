...
/**
 * The EditMenu class provides functionality to edit the menu of a branch.
 * It allows users to edit menu items, add new menu items, remove menu items, and display the menu.
 */
public class EditMenu {
    ...
    public EditMenu(){}
    /**
     * Displays a menu to the user and handles the selected option for editing the menu.
     *
